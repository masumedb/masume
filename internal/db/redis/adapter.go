...
// ListSchemas returns the database the connection opened. A Redis connection holds one
// numbered database, and SELECT is the only way to another.
func (session *redisSession) ListSchemas(context.Context) ([]string, error) {

...
var HelpSections = []HelpSection{
	...
	},
	{
		...
		Entries: []HelpEntry{
			...
			{Scope: cfg.ScopeGlobal, Actions: []ActionID{ActionShowNotebooks}, Text: "list project and user notebooks"},
			{Scope: cfg.ScopeGlobal, Actions: []ActionID{ActionSaveQuery}, Text: "save this notebook to its file"},
			{Scope: cfg.ScopeGlobal, Actions: []ActionID{ActionNotebookRunPolicy}, Text: "set the transaction and error policy"},
			{Scope: cfg.ScopeNotebook, Actions: []ActionID{ActionCursorUp, ActionCursorDown}, Text: "move between cells"},
			{Scope: cfg.ScopeNotebook, Actions: []ActionID{ActionEditCellSource}, Text: "edit the focused cell"},
			{Scope: cfg.ScopeEditor, Actions: []ActionID{ActionLeaveCell}, Text: "leave the cell and go back to the list"},
	...
	},
	{
		...
		Entries: []HelpEntry{
			...
			{Scope: cfg.ScopeBuilder, Actions: []ActionID{ActionPickColumn}, Text: "add the column to SELECT"},
			{Scope: cfg.ScopeBuilder, Actions: []ActionID{ActionEditBuilderRow}, Text: "edit the aggregate, alias and sort"},
	...
	},
	{
		...
		Entries: []HelpEntry{
			...
			{Scope: cfg.ScopeEditor, Actions: []ActionID{ActionPasteText}, Text: "paste from the system clipboard"},
			...
			{Scope: cfg.ScopeDialog, Actions: []ActionID{ActionAcceptCompletion}, Text: "accept a completion"},
		},
	},
	{
		...
		Entries: []HelpEntry{
			...
			{Scope: cfg.ScopeEditor, Actions: []ActionID{ActionReplaceMatch}, Text: "replace the match and go to the next"},
			{Scope: cfg.ScopeDialog, Actions: []ActionID{ActionToggleWholeWord}, Text: "toggle whole-word matching"},
			{Scope: cfg.ScopeEditor, Actions: []ActionID{ActionShowCompletion}, Text: "complete the word under the caret"},
		},
	},
	{
	...
	},
	{
		...
		Entries: []HelpEntry{
			...
			{Scope: cfg.ScopeDialog, Actions: []ActionID{ActionUseKeyring}, Text: "keep the password in the keyring, in the password field"},
		},
	},
	{
		Title: "ai chat",
		Entries: []HelpEntry{
			...
			{Scope: cfg.ScopeDialog, Actions: []ActionID{ActionSendQuestion}, Text: "send the question"},
			{Scope: cfg.ScopeDialog, Actions: []ActionID{ActionWriteNewline}, Text: "a newline in the question"},
			{Scope: cfg.ScopeDialog, Actions: []ActionID{ActionInsertAiSQL}, Text: "insert the most recent query of the chat into the editor, or as a cell"},
			{Scope: cfg.ScopeDialog, Actions: []ActionID{ActionChatToNotebook}, Text: "turn this conversation into a notebook"},
			{Scope: cfg.ScopeDialog, Actions: []ActionID{ActionAskAiAgain}, Text: "ask the last question again"},
			{Scope: cfg.ScopeDialog, Actions: []ActionID{ActionCopyAiReply}, Text: "copy the last reply"},
